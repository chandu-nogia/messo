...
import 'package:flutter_lovexa_ecommerce/common/basewidget/demo_reset_dialog_widget.dart';
...
import 'package:flutter_lovexa_ecommerce/features/restock/widgets/restock_%20bottom_sheet.dart';
  ...
  static Future<void> initialize(
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      ...
      if (message.data['type'] == 'maintenance_mode') {
        ...
        await splashProvider.initConfig(GetCtx.context!, null, null);
        ...
        debugPrint(
            "--------(NOTIFICATION HELPER)-----------${Provider.of<SplashController>(GetCtx.context!, listen: false).isMaintenanceModeScreen()}-------");
      ...
      if (message.data['type'] == 'product_restock_update' &&
          !Provider.of<RestockController>(GetCtx.context!, listen: false)
              .isBottomSheetOpen) {
