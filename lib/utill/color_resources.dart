...
class ColorResources {
  ...
  static Color iconBg() {
    return Provider.of<ThemeController>(GetCtx.context!).darkTheme
        ? Theme.of(GetCtx.context!).primaryColor.withValues(alpha: .05)
        : const Color(0xffF9F9F9);
  }
  ...
  static const Color yellow = Color(0xFFf8e016);
  ...
  static const Color circulColor = Color(0xffF6F6F6 );
  // static const Color circulColor = Colors.yellow;
  // static const Color yellowClr = Color(0xfff9d209);
