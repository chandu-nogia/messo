import 'package:flutter_lovexa_ecommerce/localization/models/language_model.dart';
import 'package:flutter_lovexa_ecommerce/utill/images.dart';

class AppConstants {
  static const String appName = 'LOVEXA';
  static const String slogan = 'E-Commerce Marketplace';
  static const String appVersion = '15.1';

  ///Flutter SDK 3.27.4

  // static const String baseUrl = 'https://lovexa-test.deveuonusit.xyz';
  static const String baseUrl = 'https://lovexa.ai';
  ...
  //address
  static const String adressUpDate =
      '/api/v1/customer/address/set-primary-address';
