...
class Dimensions {
  static double fontSizeExtraSmall =
      ResponsiveHelper.isTab(GetCtx.context) ? 14 : 10.0;
  static double fontSizeSmall =
      ResponsiveHelper.isTab(GetCtx.context) ? 16 : 12.0;
  static double fontSizeDefault =
      ResponsiveHelper.isTab(GetCtx.context) ? 18 : 14.0;
  static double fontSizeLarge =
      ResponsiveHelper.isTab(GetCtx.context) ? 22 : 16.0;
  static double fontSizeExtraLarge =
      ResponsiveHelper.isTab(GetCtx.context) ? 26 : 18.0;
  static double fontSizeOverLarge =
      ResponsiveHelper.isTab(GetCtx.context) ? 28 : 24.0;
  ...
  static const double menuIconSize = 23.0;
