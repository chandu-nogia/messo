...
class DateConverter {
  ...
  static String compareDates(String inputDate) {
    ...
    if (hoursDifference < 1) {
      ...
      return '$hoursDifference ${getTranslated("hr ago", GetCtx.context!)}';
    } else if (daysDifference == 1) {
      return '${getTranslated("yesterday", GetCtx.context!)}';
    } else if (daysDifference >= 2 && daysDifference <= 7) {
      return '$daysDifference ${getTranslated("days_ago", GetCtx.context!)}';
    } else {
