...
import 'package:flutter_lovexa_ecommerce/features/profile/widgets/delete_account_bottom_sheet_widget.dart';
...
class _ProfileScreen1State extends State<ProfileScreen1> {
  ...
  final TextEditingController _confirmPasswordController =
      TextEditingController();
       final emailValidatorRegExp = RegExp(r"^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$");
  ...
  imageRemove() => setState(() => file = null);
    ...
    if (1 != 1
      ...
      await Provider.of<ProfileController>(context, listen: false)
        ...
        if (response.isSuccess) {
          ...
          showCustomSnackBar(
              getTranslated(
                  'profile_info_updated_successfully', GetCtx.context!),
              GetCtx.context!,
              isError: false);
          ...
          showCustomSnackBar(response.message ?? '', GetCtx.context!,
              isError: true);
        }
      });
    }
                ...
                children: [
                  ...
                  Positioned.fill(
                    ...
                    child: Container(
                        ...
                        (firstImage==true&& file==null)?ClipRRect(
                  ...
                  // Positioned(right: 15, bottom: 15, child: Text("Change")),
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      CustomTextFieldWidget(
                        ...
                        suffixIcon: (isMailChanged ||
                            ...
                            : (config?.customerVerification?.email == 1 &&
                                ...
                                : Images.verifiedSvg,
                        toolTipMessage: (config?.customerVerification?.email ==
                                    1 &&
                      ...
                      CustomTextFieldWidget(
                          ...
                          hintText:
                              getTranslated('enter_7_plus_character', context),
