...
import 'package:flutter_lovexa_ecommerce/features/auth/widgets/code_picker_widget.dart';
...
import 'package:flutter_lovexa_ecommerce/features/location/screens/select_location_screen.dart';
...
import 'package:flutter_lovexa_ecommerce/features/splash/domain/models/config_model.dart'
    as config;
import 'package:flutter_lovexa_ecommerce/helper/country_code_helper.dart';
import 'package:flutter_lovexa_ecommerce/helper/velidate_check.dart';
...
import 'package:flutter_lovexa_ecommerce/common/basewidget/success_dialog_widget.dart';
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(
                                height: Dimensions.paddingSizeDefaultAddress),
                            CustomTextFieldWidget(
                              labelText: getTranslated('State', context),
                              ...
                              // nextFocus: _zipNode,
                              prefixIcon: Images.city,
                              controller: locationController.stateController,
                              validator: (value) =>
                                  ValidateCheck.validateEmptyText(
                            ...
                            Provider.of<SplashController>(context,
                                ...
                                ? CustomTextFieldWidget(
                                    ...
                                    prefixIcon: Images.city,
                                    controller:
                                        locationController.zipCodeController,
                                    validator: (value) =>
                                        ValidateCheck.validateEmptyText(
    ...
    if (permission == LocationPermission.denied ||
      ...
      InkWell(
          onTap: () async {
            ...
            _checkPermission(callback, GetCtx.context!);
          },
          child: AlertDialog(
              content: SuccessDialog(
                  icon: Icons.location_on_outlined,
                  title: '',
                  description: getTranslated('you_denied', GetCtx.context!))));
