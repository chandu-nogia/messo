...
import 'package:flutter_lovexa_ecommerce/features/chat/domain/models/message_body.dart';
import 'package:flutter_lovexa_ecommerce/features/chat/domain/models/message_model.dart';
import 'package:flutter_lovexa_ecommerce/features/chat/screens/media_viewer_screen.dart';
import 'package:flutter_lovexa_ecommerce/features/chat/widgets/custom_image_pick_bottom_sheet.dart';
import 'package:flutter_lovexa_ecommerce/helper/date_converter.dart';
import 'package:flutter_lovexa_ecommerce/helper/image_size_checker.dart';
...
import 'package:flutter_lovexa_ecommerce/common/basewidget/custom_textfield_widget.dart';
...
import 'package:flutter_lovexa_ecommerce/features/chat/widgets/chat_shimmer_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/chat/widgets/message_bubble_widget.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  bool _isMediaExist(ChatController chatController) {
    return (chatController.pickedMediaStored?.isNotEmpty ?? false) ||
  ...
  bool _isMsgValid(ChatController chatController) {
    ...
    bool isFileMsgValid = (chatController.pickedFiles?.isNotEmpty ?? false) &&
        !chatController.pickedFIleCrossMaxLength;
    bool isTextMsgValid =
        _controller.text.isNotEmpty && !chatController.pickedFIleCrossMaxLength;
      ...
      body: Stack(
        children: [
          Consumer<ChatController>(
              builder: (context, chatController, child) => Column(children: [
                    chatController.messageModel != null
                        ? (chatController.messageModel!.message != null &&
                                chatController
                                  ...
                                  child: PaginatedListView(
                                    ...
                                    itemView: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return Column(
                                          crossAxisAlignment: chatController
                                                      .messageModel
                                                      ?.message?[index]
                                                      .sentByCustomer ??
                                                  false
                    ...
                    chatController.isSending
                        ...
                        : const SizedBox(),
                    Container(
                      color: (chatController.isLoading == false &&
                              _isMediaExist(chatController))
                          ? Theme.of(context)
                              .primaryColor
                      ...
                      child: Column(
                          ...
                          children: [
                            _isMediaExist(chatController)
                                ...
                                : const SizedBox(),
                            (chatController.pickedMediaStored?.isNotEmpty ??
                                    false)
                                ? Container(
                                    height:
                                        (chatController
                                      ...
                                      children: [
                                        SizedBox(
                                          ...
                                          child: ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              if (kDebugMode) {
                                                print(
                                                    '--------path: ${chatController.pickedMediaStored?[index].thumbnailPath}');
                                              }
                                                                    ...
                                                                    MaterialPageRoute(
                                                                      builder:
                                                                        ...
                                                                        clickedIndex:
                                                                            index,
                                                                        localMedia:
                                                                            chatController.getXFileFromMediaFileModel(chatController.pickedMediaStored ??
                                                                                []),
                                                                      ),
                                                                    )),
                                                            child: Container(
                                        ...
                                        if (chatController
                                            ...
                                            chatController
                                                .singleFIleCrossMaxLimit)
                                          Text(
                                            "${chatController.pickedFIleCrossMaxLength ? "• ${getTranslated('can_not_select_more_than', context)!} ${AppConstants.maxLimitOfTotalFileSent.floor()} 'files' " : ""} "
                              ...
                              child: SizedBox(
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          onTap: (chatController.isSending &&
                                                  chatController.isLoading)
                                              ? null
                                              : () {
                                                  if (!_isMsgValid(
                                                    ...
                                                    chatController
                                                        ...
                                                        ? showCustomSnackBar(
                                                            getTranslated(
                                                                'can_not_select_more_than_5_files',
                                                                context),
                                                            context)
                                                        : showCustomSnackBar(
                                                            getTranslated(
  ...
  String? _willShowDate(int index, MessageModel? messageModel) {
    ...
    DateTime? currentMessageDate = currentMessage.createdAt == null
        ? null
        : DateTime.tryParse(currentMessage.createdAt!);
    DateTime? nextMessageDate = nextMessage?.createdAt == null
        ? null
