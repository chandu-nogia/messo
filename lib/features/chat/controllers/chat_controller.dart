...
import 'package:flutter_lovexa_ecommerce/features/chat/domain/models/media_file_model.dart';
...
import 'package:flutter_lovexa_ecommerce/features/chat/domain/models/chat_model.dart';
...
class ChatController extends ChangeNotifier {
  ...
  Future<http.StreamedResponse> sendMessage(MessageBody messageBody,
    ...
    if (response.statusCode == 200) {
      getMessageList(GetCtx.context!, messageBody.id, 1,
