...
import 'package:flutter_lovexa_ecommerce/features/coupon/widgets/coupon_item_widget.dart';
              ...
              Expanded(child: Padding(padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeDefault),
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index){
                      print('couponProvider.availableCouponList!.length: ${couponProvider.availableCouponList!.length}');
