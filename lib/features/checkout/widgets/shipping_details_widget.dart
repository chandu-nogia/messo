...
import 'package:flutter_lovexa_ecommerce/features/checkout/widgets/create_account_widget.dart';
                                    ...
                                    (shippingProvider.addressIndex == null ||
                                        ...
                                        : Column(children: [
                                            ...
                                            AddressInfoItem(
                                                icon: Images.address,
                                                title:
                                                    "${locationProvider.addressList[shippingProvider.addressIndex!].address ?? ''}, ${locationProvider.addressList[shippingProvider.addressIndex!].city ?? ''}, ${locationProvider.addressList[shippingProvider.addressIndex!].state ?? ''}, ${locationProvider.addressList[shippingProvider.addressIndex!].zip ?? ''}"),
                                          ])
                                  ]),
                            ])))
                : const SizedBox(),
