...
import 'package:flutter_lovexa_ecommerce/features/offline_payment/domain/models/offline_payment_model.dart';
...
import 'package:flutter_lovexa_ecommerce/features/checkout/screens/digital_payment_order_place_screen.dart';
...
class CheckoutController with ChangeNotifier {
    ...
    isfOffline
        ...
        : wallet
            ...
            : apiResponse =
                ...
                currentCurrencyCode: Provider.of<SplashController>(
                        GetCtx.context!,
                        listen: false)
                    .myCurrency
                    ?.code,
  ...
  Future<ApiResponse> digitalPaymentPlaceOrder(
    ...
    if (apiResponse.response != null &&
      ...
      _isLoading = false;
      showCustomSnackBar('${getTranslated(apiResponse.error, GetCtx.context!)}',
          GetCtx.context!);
    } else {
      _isLoading = false;
      showCustomSnackBar(
          '${getTranslated('payment_method_not_properly_configured', GetCtx.context!)}',
          GetCtx.context!);
    }
    notifyListeners();
    return apiResponse;
