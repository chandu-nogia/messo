...
import 'package:flutter_lovexa_ecommerce/features/address/screens/saved_address_list_screen.dart';
import 'package:flutter_lovexa_ecommerce/features/address/screens/saved_billing_address_list_screen.dart';
import 'package:flutter_lovexa_ecommerce/features/cart/domain/models/cart_model.dart';
import 'package:flutter_lovexa_ecommerce/features/checkout/controllers/checkout_controller.dart';
import 'package:flutter_lovexa_ecommerce/features/checkout/widgets/payment_method_bottom_sheet_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/offline_payment/screens/offline_payment_screen.dart';
...
import 'package:flutter_lovexa_ecommerce/common/basewidget/amount_widget.dart';
import 'package:flutter_lovexa_ecommerce/common/basewidget/animated_custom_dialog_widget.dart';
...
import 'package:flutter_lovexa_ecommerce/features/checkout/widgets/order_place_dialog_widget.dart';
...
import 'package:flutter_lovexa_ecommerce/features/checkout/widgets/choose_payment_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/checkout/widgets/coupon_apply_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/checkout/widgets/shipping_details_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/checkout/widgets/wallet_payment_widget.dart';
...
class CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration(seconds: 1), () {
      ...
      print("index vlue:: $indexValue");
      Future.delayed(Duration(seconds: 1), () {
        if (indexValue > -1) {
          Provider.of<CheckoutController>(context, listen: false)
              .setAddressIndex(indexValue);
          setState(() {});
          // Provider.of<AddressController>(context, listen: false).getAddressList();
        }
      });
                ...
                return orderProvider.isLoading
                    ...
                    : Padding(
                        ...
                        child: CustomButton(
                          onTap: () async {
                            print(
                                "order addresh index:: ${orderProvider.addressIndex}  widget hasphysics ::: ${widget.hasPhysical}");
                            ...
                            if (orderProvider.addressIndex == null ||
                              ...
                              showCustomSnackBar(
                                  ...
                                  context,
                                  isToaster: true);
                            } else if (locationProvider.addressList.isEmpty) {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (BuildContext context) =>
                                      const SavedAddressListScreen()));
                              showCustomSnackBar(
