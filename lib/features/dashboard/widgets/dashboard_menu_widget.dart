  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Padding(padding: const EdgeInsets.all(0),
        child: SizedBox(
          width: isSelected ? 70 : 30, child: Column(crossAxisAlignment: CrossAxisAlignment.center,
          mainAxisAlignment: MainAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [

            Stack(children: [
              // Container(decoration: BoxDecoration(image: DecorationImage(image: AssetImage(icon))),
                // child: 
                Image.asset(
            ...
            Text(getTranslated(
              name, context)!, maxLines: 1, overflow: TextOverflow.ellipsis,
