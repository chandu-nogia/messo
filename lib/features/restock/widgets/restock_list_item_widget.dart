...
import 'package:flutter_lovexa_ecommerce/features/restock/domain/models/restock_product_model.dart';
...
class RestockListItemWidget extends StatelessWidget {
  ...
  final Data? data;
  final int index;
  const RestockListItemWidget(
      {super.key, this.product, this.ratting, this.data, required this.index});
        ...
        Positioned(
            ...
            child: InkWell(
              onTap: () async {
                ...
                await Provider.of<RestockController>(context, listen: false)
                    .deleteRestockProduct(data!.id.toString(), '', index);
              ...
              child: Container(
                ...
                child: Center(
                  child: Icon(Icons.close,
                      color: Theme.of(context).cardColor, weight: 15, size: 15),
                ),
              ),
            )),
      ],
