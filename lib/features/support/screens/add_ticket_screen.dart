...
import 'package:flutter_lovexa_ecommerce/features/support/widgets/priority_bottom_sheet_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/support/widgets/support_ticket_type_widget.dart';
...
class AddTicketScreenState extends State<AddTicketScreen> {
  ...
  final List<String> categories = [
    ...
    // 'Info Inquiry'
    'General',
    'Delivery related queries', 'Payment Gateway issues', 'Business Support',
  ];
                  ...
                  child: Row(children: [
                    ...
                    Padding(
                        ...
                        child: Text(
                            getTranslated(
                                widget.orderId != null
                                    ? "Order Support - ${widget.orderId.toString()}"
                      ...
                      onTap: () {
                        if (_subjectController.text.isEmpty) {
                          ...
                          SupportTicketBody supportTicketModel =
                              SupportTicketBody(
                                  type: categories[widget.categoryIndex],
                                  subject: _subjectController.text,
                                  description: _descriptionController.text,
                                  priority:
                                      supportTicketProvider.selectedPriorityEn,
