...
import 'package:flutter_lovexa_ecommerce/features/shop/screens/shop_screen.dart';
...
class BannerController extends ChangeNotifier {
  ...
  List<BannerModel>? _mainSectionBanner2;
  ...
  List<BannerModel>? get mainSectionBanner2 => _mainSectionBanner2;
  ...
  Future<void> getBannerList(bool reload) async {
    var localData =
        await database.getCacheResponseById(AppConstants.getBannerList);
    ...
    if (localData != null) {
      ...
      bannerList!.forEach((bannerModel) {
        if (bannerModel['banner_type'] == 'Main Banner') {
          ...
          _mainSectionBanner2?.add(BannerModel.fromJson(bannerModel));
          // print(" banner ::::::::: ${bannerModel['banner_type']}");
