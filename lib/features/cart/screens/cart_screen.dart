...
import 'package:flutter_lovexa_ecommerce/features/cart/widgets/cart_page_shimmer_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/cart/widgets/cart_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/checkout/screens/checkout_screen.dart';
import 'package:flutter_lovexa_ecommerce/features/shipping/widgets/shipping_method_bottom_sheet_widget.dart';
...
class CartScreenState extends State<CartScreen> {
  Future<void> _loadData() async {
    await Provider.of<CartController>(GetCtx.context!, listen: false)
        .getCartData(GetCtx.context!);
    Provider.of<CartController>(GetCtx.context!, listen: false).setCartData();
    if (Provider.of<SplashController>(GetCtx.context!, listen: false)
            .configModel!
            .shippingMethod !=
        'sellerwise_shipping') {
      Provider.of<ShippingController>(GetCtx.context!, listen: false)
          .getAdminShippingMethodList(GetCtx.context!);
    }
  }

  Color _currentColor = Theme.of(GetCtx.context!).cardColor; // Initial color
  final Duration duration = const Duration(milliseconds: 500);
  void changeColor() {
    setState(() {
      _currentColor = (_currentColor == Theme.of(GetCtx.context!).cardColor)
          ? Colors.grey.withValues(alpha: .15)
          : Theme.of(GetCtx.context!).cardColor;
                                    ...
                                    if (configProvider
                                      ...
                                      for (int i = 0;
                                        ...
                                        showModalBottomSheet(
                                          ...
                                          backgroundColor: Colors.transparent,
                                          builder: (context) {
                                            return ShippingMethodBottomSheetWidget(
                                                groupId: sellerGroupList[i]
                                                    .cartGroupId,
                                                sellerIndex: i,
                                                sellerId:
                                                    sellerGroupList[i].id);
                                          },
                                        );
                                      }
                                    } else if (minimum) {
                                                                        ...
                                                                        if (shopClose)
                                                                          JustTheTooltip(
                                                                            ...
                                                                            content: Container(
                                                                                ...
                                                                                child: Text(getTranslated('store_is_closed', context)!, style: textRegular.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeDefault))),
                                                                            child:
                                                                                InkWell(
                                                                    ...
                                                                    ? Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Container(
                                                                            decoration:
                                                                                BoxDecoration(border: Border.all(width: 0.5, color: Colors.grey), borderRadius: const BorderRadius.all(Radius.circular(10))),
                                                                            child:
                                                                                Padding(
