...
import 'package:flutter_lovexa_ecommerce/features/cart/widgets/cart_quantity_button_widget.dart';
                                        ...
                                        Padding(
                                            padding: const EdgeInsets.only(
                                                top: Dimensions
                                                    .paddingSizeExtraSmall),
                                            child: Text(
                                            cartModel!.taxModel == 'exclude'?  '(${getTranslated('tax', context)} : ${PriceConverter.convertPrice(context, cartModel?.tax)}d)':'(${getTranslated('tax', context)} ${cartModel!.taxModel}d)',
                                              style: textRegular.copyWith(
                                                  color: ColorResources
                                                      .hintTextColor,
                                                  fontSize: Dimensions
