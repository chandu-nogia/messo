...
class CategoryController extends ChangeNotifier {
  ...
  int? _subCatSelectedIndex;

  List<CategoryModel> get categoryList => _categoryList;
  int get categorySelectedIndex => _categorySelectedIndex;
  int? get subCatSelectedIndex => _subCatSelectedIndex;

  Future<void> getCategoryList(bool reload) async {
    final localData =
        await database.getCacheResponseById(AppConstants.categoriesUri);
  ...
  void clearAllSelectedCategories() {
  ...
  void changeSubCatSelectedIndex(int selectedIndex) {
    _subCatSelectedIndex = selectedIndex;
    notifyListeners();
  }
}
