...
import 'package:flutter_lovexa_ecommerce/features/auth/domain/models/register_model.dart';
...
import 'package:flutter_lovexa_ecommerce/data/model/response_model.dart';
...
import 'package:flutter_lovexa_ecommerce/features/auth/domain/models/user_log_data.dart';
...
import 'package:flutter_lovexa_ecommerce/features/auth/screens/otp_verification_screen.dart';
import 'package:flutter_lovexa_ecommerce/features/auth/screens/reset_password_screen.dart';
...
class AuthController with ChangeNotifier {
  ...
  Future<void> socialLogin(
    ...
    if (apiResponse.response != null &&
      ...
      if (token != null) {
        ...
        setCurrentLanguage(
            Provider.of<LocalizationController>(GetCtx.context!, listen: false)
                    .getCurrentLanguage() ??
                'en');
      }
  ...
  Future<ResponseModel> login(String? userInput, String? password, String? type,
    ...
    ApiResponse apiResponse =
        await authServiceInterface.login(userInput, password, verificationType);
  ...
  Future<ResponseModel> checkEmail(String email, FromPage? fromPage) async {
    ...
    if (apiResponse.response != null &&
      ...
      showCustomSnackBar(_verificationMsg, GetCtx.context!);
    ...
    await FirebaseAuth.instance.verifyPhoneNumber(
      ...
      verificationFailed: (FirebaseAuthException e) {
        ...
        if (e.code == 'invalid-phone-number') {
          showCustomSnackBar(
              getTranslated(
                  'please_submit_a_valid_phone_number', GetCtx.context!),
              GetCtx.context!);
        } else {
          showCustomSnackBar(
  ...
  Future<ResponseModel> verifyEmail(String email) async {
    ...
    if (apiResponse.response != null &&
      ...
      // final ProfileProvider profileProvider = Provider.of<ProfileProvider>(GetCtx.context!, listen: false);
  ...
  Future<ResponseModel> registerWithOtp(String name,
    ...
    if (apiResponse.response != null &&
      ...
      showCustomSnackBar(_loginErrorMessage, GetCtx.context!);
  ...
  Future<ResponseModel> verifyProfileInfo(String userInput, String type) async {
    ...
    if (apiResponse.response != null &&
      ...
      profileProvider.getUserInfo(GetCtx.context!);
  ...
  Future<ResponseModel> verifyPhone(String phone, String token) async {
    ...
    if (apiResponse.response != null &&
      ...
      _verificationMsg = ApiChecker.getError(apiResponse).errors![0].message;
      showCustomSnackBar(_verificationMsg, GetCtx.context!, isError: true);
      responseModel = ResponseModel(_verificationMsg, false);
    }
  ...
  Future<ApiResponse> resetPassword(String identity, String otp,
    ...
    if (apiResponse.response != null &&
        apiResponse.response!.statusCode == 200) {
      showCustomSnackBar(
          getTranslated('password_reset_successfully', GetCtx.context!),
          GetCtx.context!,
          isError: false);
      Navigator.pushAndRemoveUntil(
          GetCtx.context!,
