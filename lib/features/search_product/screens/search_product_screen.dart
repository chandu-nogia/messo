...
import 'package:flutter_lovexa_ecommerce/features/search_product/widgets/partial_matched_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/search_product/widgets/search_product_widget.dart';
...
import '../../../main.dart';
import 'infinit_search_screen.dart';
                        ...
                        slivers: [
                          ...
                          SliverToBoxAdapter(
                              child: Column(
                                ...
                                //         ]),
                                //     child:
                                //         SearchSuggestion()), //!--------------------> search controller
                                const SizedBox(
                          ...
                          (searchProvider
                              ...
                              (searchProvider
                                          .searchController.text.isNotEmpty &&
                                      searchProvider.fetchedSearchProducts !=
                                          null)
                                  ? SearchInfinitScrollingWidget()
                                  // SearchProductWidget(
                                                                ...
                                                                padding: const EdgeInsets
                                                                    ...
                                                                    vertical:
                                                                        Dimensions
                                                                            .paddingSizeSmall),
                                                                child: Container(
                                                                    decoration: BoxDecoration(borderRadius: const BorderRadius.all(Radius.circular(50)), color: Provider.of<ThemeController>(context, listen: false).darkTheme ? Colors.grey.withValues(alpha: 0.2) : Theme.of(context).colorScheme.onPrimary.withValues(alpha: .1)),
                                                                    ...
                                                                    child: InkWell(
                                                                        onTap: () {
                                                                          ...
                                                                          //     query: searchProvider.historyList[
                                                                          //         index],
                                                                          //     offset:
                                                                          //         1);
                                                                          ...
                                                                          _pageController
                                                                              .searchText
                                                                              .value = searchProvider.historyList[index].toString();
                                                                        ...
                                                                        child: ConstrainedBox(
                                                                            ...
                                                                            child: Row(mainAxisSize: MainAxisSize.min, children: [
                                                                              Flexible(child: Text(searchProvider.historyList[index], style: textRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color), overflow: TextOverflow.ellipsis)),
                                                                              const SizedBox(
                                                          ...
                                                          child: Container(
                                                              ...
                                                              child: InkWell(
                                                                  ...
                                                                  child: ConstrainedBox(
                                                                      ...
                                                                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                                                                        Flexible(
                                                                            child: Text(popularTagProvider.configModel!.popularTags![index].tag ?? '',
