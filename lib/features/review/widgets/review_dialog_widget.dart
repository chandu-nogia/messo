...
import 'package:flutter_lovexa_ecommerce/features/review/domain/models/review_body.dart';
...
class _ReviewDialogState extends State<ReviewDialog> {
  @override
  void initState() {
    Provider.of<ReviewController>(GetCtx.context!, listen: false)
        .initReviewImage();
    loadData();
    super.initState();
  }
  ...
  Future<void> loadData() async {
    await Provider.of<ReviewController>(GetCtx.context!, listen: false)
        .getOrderWiseReview(widget.productID, widget.orderId);
    if (Provider.of<ReviewController>(GetCtx.context!, listen: false)
            .orderWiseReview !=
        null) {
      Provider.of<ReviewController>(GetCtx.context!, listen: false).setRating(
          Provider.of<ReviewController>(GetCtx.context!, listen: false)
              .orderWiseReview!
              .rating!);
      _controller.text =
