...
import '../../tracking/screens/tracking_result_screen.dart';
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => OrderDetailsScreen(orderId: orderModel!.id, orderModel: orderModel)));
        // if (orderModel!.orderStatus == 'delivered') {
        //   Provider.of<OrderController>(context, listen: false).deliverChange(1);
        // }else if (orderModel!.orderStatus == 'ongoing') {
        //   Provider.of<OrderController>(context, listen: false).deliverChange(0);
        // }else if (orderModel!.orderStatus == 'canceled') {
        //   Provider.of<OrderController>(context, listen: false).deliverChange(2);
        // }else if (orderModel!.orderStatus == 'all') {
        //   Provider.of<OrderController>(context, listen: false).deliverChange(3);
        // }
                    ...
                    Container(
                      ...
                      child: ClipRRect(
                          ...
                          child: CustomImageWidget(
                              ...
                              height: 70,
                              image:
                                  '${orderModel?.orderThumbnailFullUrl?.path}'
                  ...
                  children: [
                    Container(
                        ...
                        decoration: BoxDecoration(
                            color: orderModel!.orderStatus == 'delivered'
                                ? ColorResources.getGreen(context).withValues(
                                    alpha: .10)
                    ...
                    (Provider.of<AuthController>(context, listen: false)
                            ...
                            orderModel!.customerId! ==
                                int.parse(Provider.of<ProfileController>(
                                        context,
                                        listen: false)
                                    .userID) &&
                            orderModel!.orderType != "POS" &&
