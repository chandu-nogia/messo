...
import 'package:flutter_lovexa_ecommerce/features/order_details/widgets/cal_chat_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/order_details/widgets/cancel_and_support_center_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/order_details/widgets/order_amount_calculation.dart';
import 'package:flutter_lovexa_ecommerce/features/order_details/widgets/order_details_status_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/order_details/widgets/ordered_change_amount_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/order_details/widgets/ordered_product_list_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/order_details/widgets/payment_info_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/order_details/widgets/seller_section_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/order_details/widgets/shipping_and_billing_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/order_details/widgets/shipping_info_widget.dart';
...
import 'package:flutter_lovexa_ecommerce/common/basewidget/image_diaglog_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/dashboard/screens/dashboard_screen.dart';
import 'package:flutter_lovexa_ecommerce/features/home/shimmers/order_details_shimmer.dart';
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  void _loadData(BuildContext context) async {
    if (Provider.of<AuthController>(context, listen: false).isLoggedIn() &&
        !widget.fromTrack) {
      await Provider.of<OrderDetailsController>(GetCtx.context!, listen: false)
          .getOrderDetails(widget.orderId.toString());
      await Provider.of<OrderController>(GetCtx.context!, listen: false)
  ...
  void initState() {
    ...
    if (Provider.of<SplashController>(context, listen: false).configModel ==
      ...
      Provider.of<SplashController>(context, listen: false)
          ...
          .then((value) {
        _loadData(GetCtx.context!);
        Provider.of<OrderDetailsController>(GetCtx.context!, listen: false)
            .digitalOnly(true);
      });
    } else {
      _loadData(context);
                          ...
                          ? ListView(
                              ...
                              children: [
                                ...
                                OrderedChangeAmountWidget(
                                  amount:
                                      orderProvider.orders?.bringChangeAmount ??
                                          0,
                                  currency: orderProvider
                                          .orders?.bringChangeAmountCurrency ??
                                      '',
                                ),
                                const SizedBox(
                                    height: Dimensions.paddingSizeSmall),
