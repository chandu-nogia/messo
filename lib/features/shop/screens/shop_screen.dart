...
import 'package:flutter_lovexa_ecommerce/common/basewidget/search_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/home/screens/home_screens.dart';
import 'package:flutter_lovexa_ecommerce/features/shop/screens/overview_screen.dart';
import 'package:flutter_lovexa_ecommerce/features/shop/widgets/shop_product_view_list.dart';
...
class _TopSellerProductScreenState extends State<TopSellerProductScreen>
  ...
  void _load() async {
    await Provider.of<ShopController>(GetCtx.context!, listen: false)
        .getClearanceShopProductList(
            'clearance_sale', '1', widget.sellerId.toString());
    await Provider.of<SellerProductController>(GetCtx.context!, listen: false)
    ...
    await Provider.of<CouponController>(GetCtx.context!, listen: false)
        .getSellerWiseCouponList(widget.sellerId!, 1);
    await Provider.of<CategoryController>(GetCtx.context!, listen: false)
        .getSellerWiseCategoryList(widget.sellerId!);
    await Provider.of<BrandController>(GetCtx.context!, listen: false)
      ...
      onPopInvokedWithResult: (didPop, _) {
        ...
        Provider.of<CategoryController>(GetCtx.context!, listen: false)
            .getCategoryList(true);
             Provider.of<BrandController>(GetCtx.context!, listen: false).getBrandList(true);
      },
      child: SafeArea(
        top: true,
        bottom: false,
        child: Scaffold(
            ...
            body:
                Consumer<ShopController>(builder: (context, sellerProvider, _) {
                    ...
                    delegate: SliverDelegate(
                        child: InkWell(
                            ...
                            child: const Hero(
                                tag: 'search',
                                child:
                                    Material(child: SearchHomePageWidget()))))),
                // SliverToBoxAdapter(
                                          ...
                                          child: Padding(
                                            ...
                                            child: TabBar(
                                              ...
                                              tabs: [
                                                Tab(
                                                    text:
                                                        "${homeTitleModel.mallLatestProductHeading ?? 'Lovexa Exclusive'}"
                                                    // getTranslated(
                                                    //     "latest_products", context)
                                                    ),
                                                Tab(
                                                    text:
                                                        "${homeTitleModel.mallAllProductHeading ?? 'Lovexa Product'}"
                                                    // getTranslated(
                                                    //     "all_products",
                                                    //     context)
                                                    ),
