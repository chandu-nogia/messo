...
import 'package:flutter_lovexa_ecommerce/features/clearance_sale/widgets/clearance_sale_shop_list_widget.dart';
...
import 'package:flutter_lovexa_ecommerce/features/shop/widgets/shop_coupon_item_widget.dart';
import 'package:flutter_lovexa_ecommerce/features/shop/widgets/shop_featured_product_list_view.dart';
import 'package:flutter_lovexa_ecommerce/features/shop/widgets/shop_recommanded_product_list.dart';
...
class _ShopOverviewScreenState extends State<ShopOverviewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Consumer<CouponController>(builder: (context, couponController, _) {
                    ...
                    ? Stack(children: [
                        CarouselSlider.builder(
                          options: CarouselOptions(
                              ...
                              // autoPlay: true,
                              autoPlay: couponController
                                          .couponItemModel!.coupons!.length >
                                      1
                                  ? true
                                  : false,
                              scrollPhysics: couponController
                                          .couponItemModel!.coupons!.length >
                                      1
                          ...
                          itemBuilder: (context, index, _) => ShopCouponItem(
