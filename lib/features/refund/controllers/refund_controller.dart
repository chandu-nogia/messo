...
import 'package:flutter_lovexa_ecommerce/features/refund/domain/models/refund_info_model.dart';
import 'package:flutter_lovexa_ecommerce/features/refund/domain/models/refund_result_model.dart';
...
class RefundController with ChangeNotifier {
  ...
  Future<http.StreamedResponse> refundRequest(String orderId,
    ...
    if (response.statusCode == 200) {
      ...
      showCustomSnackBar(
          getTranslated('successfully_requested_for_refund', GetCtx.context!),
          GetCtx.context!,
          isError: false);
