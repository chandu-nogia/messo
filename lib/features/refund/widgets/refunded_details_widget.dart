...
import 'package:flutter_lovexa_ecommerce/features/refund/widgets/change_log_widget.dart';
                    ...
                    ? Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                                          ...
                                          children: [
                                            RichText(
                                                text: TextSpan(
                                                  ...
                                                  TextSpan(
                                                      text:
                                                          "${getTranslated('order_id_refund_details', context)}",
                                                      style: textRegular.copyWith(
                                                          fontSize: Dimensions
                                                              .fontSizeDefault,
                                                          color:
                                                  ...
                                                  TextSpan(
                                                      text:
                                                          "#${widget.orderDetailsModel?.orderId}",
                                        ...
                                        children: [
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  "${getTranslated('refundable_amount', context)}",
                                                  style: textRegular.copyWith(
                                                      fontSize: Dimensions
                                                          .fontSizeDefault,
                                                      color: Theme.of(context)
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.only(
                                                  left: Dimensions
                                                      .paddingSizeSmall),
                                              child: Text(
                                                "${getTranslated('request_reason_refund_details', context)}",
                                                style: textMedium.copyWith(
                                                    fontSize: Dimensions
                                                        .fontSizeDefault),
                                                overflow: TextOverflow.ellipsis,
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          "${refund.refundResultModel!.refundRequest![0].refundReason}",
                                          style: textRegular.copyWith(
                                              fontSize:
                              ...
                              if (refundReq.refundResultModel!.refundRequest![0]
