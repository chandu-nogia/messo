...
import 'package:flutter_lovexa_ecommerce/features/shipping/domain/models/chosen_shipping_method.dart';
import 'package:flutter_lovexa_ecommerce/features/shipping/domain/models/shipping_method_model.dart';
import 'package:flutter_lovexa_ecommerce/features/shipping/domain/models/shipping_model.dart';
import 'package:flutter_lovexa_ecommerce/features/checkout/domain/models/selected_shipping_type.dart';
  ...
  Future addShippingMethod(
    ...
    if (apiResponse.response != null &&
      ...
      await Provider.of<CartController>(GetCtx.context!, listen: false)
          .getCartData(GetCtx.context!, reload: false);
      Navigator.pop(GetCtx.context!);
      getChosenShippingMethod(GetCtx.context!);
      showCustomSnackBar(
          getTranslated('shipping_method_added_successfully', GetCtx.context!),
          GetCtx.context!,
          isError: false);
    } else {
      Navigator.pop(GetCtx.context!);
