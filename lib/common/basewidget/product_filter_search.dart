                                ...
                                ? InkWell(
                                    onTap: () async {
                                      ...
                                      searchProvider.resetChecked(
                                          widget.sellerId, widget.fromShop);
                                      if (context.mounted) {
                                ...
                                ConstrainedBox(
                                  ...
                                  child: SizedBox(
                                    ...
                                    children: List.generate(
                                      ...
                                      //       shrinkWrap: true,
                                      //       itemBuilder: (context, index) {
                                      //       final brands=  brandProvider.brandList[index];

                                      //         print(
                                      //             'brandProvider.brandList[index]:: ${brandProvider.brandList[index].name}');
                                      //         return CategoryFilterItem(
                                      //             title: brands.name,
                                      //             checked: brands.checked!,
                                      //             onTap: () => brandProvider
                                      //                 .checkedToggleBrand(index));
                                      //       }),
                                      // ),
